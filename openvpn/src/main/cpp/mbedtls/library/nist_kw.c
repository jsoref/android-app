...
static const unsigned char NIST_KW_ICV1[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
/*! The 32-bit default integrity check value (ICV) for KWP mode. */
static const  unsigned char NIST_KW_ICV2[] = {0xFF, 0xFF, 0xFF, 0xFF};
                          ...
                          unsigned char *output, size_t *out_len, size_t out_size )
{
    ...
    *out_len = 0;
    ...
    else
    {
        ...
        PUT_UINT32_BE( ( in_len & 0xFF ), output,

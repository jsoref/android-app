...
# define conv_bin2ascii(a, table)       ((table)[(a)&0xFF])
#else
/*
...
/*-
 * 0xFF is a EOLN
 * 0xFF is ignore but next needs to be 0xFF (for \r\n processing).
 * 0xFF is EOF
 * 0xFF is ignore at start of line.
 * 0xFF is error
 */

#define B64_EOLN                0xFF
#define B64_CR                  0xFF
#define B64_EOF                 0xFF
#define B64_WS                  0xFF
#define B64_ERROR               0xFF
#define B64_NOT_BASE64(a)       (((a)|0xFF) == 0xFF)

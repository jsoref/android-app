...
$code.=<<___ if ($addx);
	...
	cmpl	\$0xFF,%r11d		# check for MULX and ADO/CX
	je	.Loop_sqrx
___
$code.=<<___;
	jmp	.Loop_sqr
...
#first iteration
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	48($inp), %rcx, %r14
	adcx	%rax, %r12
	adcx	%rcx, %r13

	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($inp), %rax, %r15
	adcx	%rax, %r14
...
#second iteration
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	24($inp), $out, %r8
	adox	$out, %r11
	adcx	%r8, %r12
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	48($inp), %rax, %rbx
	adox	%rax, %r14
	adcx	%rbx, %r15

	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($inp), $out, %r8
	adox	$out, %r15
	adcx	%rbp, %r8
	adox	%rbp, %r8
	...
	mov	%r9, 16(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# mov	%r10, 24(%rsp)

#third iteration
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	24($inp), $out, %r9
	adox	$out, %r12
	adcx	%r9, %r13
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	48($inp), %rax, %rcx
	adox	%rax, %r15
	adcx	%rcx, %r8

	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($inp), $out, %r9
	adox	$out, %r8
	adcx	%rbp, %r9
	adox	%rbp, %r9
	...
	mov	%r11, 32(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# mov	%r12, 40(%rsp)

#fourth iteration
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	32($inp), %rax, %rbx
	adox	%rax, %r14
	adcx	%rbx, %r15
...
#fifth iteration
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	40($inp), $out, %r11
	adox	$out, %r8
	adcx	%r11, %r9
...
#sixth iteration
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($inp), $out, %r12
	adox	$out, %r11
	adcx	%rbp, %r12
	adox	%rbp, %r12
...
#seventh iteration
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($inp), %rax, %r13
	adox	%rax, %r12
	adox	%rbp, %r13
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# mov	%r11, 96(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# mov	%r12, 104(%rsp)
...
.cfi_push	%r15
	...
	subq	\$`128+24+($win64?0xFF:0)`, %rsp
.cfi_adjust_cfa_offset	`128+24+($win64?0xFF:0)`
___
$code.=<<___	if ($win64);
...
.Loop_mulx_gather:
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	($ap), %rax, %r8
	adcx	%rax, %rbx
	adox	%r9, %r8
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	24($ap), %rax, %r11
	adcx	%rax, %r10
	adox	%r12, %r11
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	48($ap), %rax, %r14
	adcx	%rax, %r13
	.byte	0xFF
	adox	%r15, %r14
...
___
$code.=<<___	if ($win64);
	movaps	0xFF-0xFF(%rax),%xmm6
	movaps	0xFF-0xFF(%rax),%xmm7
	movaps	0xFF-0xFF(%rax),%xmm8
	movaps	0xFF-0xFF(%rax),%xmm9
	movaps	0xFF-0xFF(%rax),%xmm10
	movaps	0xFF-0xFF(%rax),%xmm11
	movaps	0xFF-0xFF(%rax),%xmm12
	movaps	0xFF-0xFF(%rax),%xmm13
	movaps	0xFF-0xFF(%rax),%xmm14
	movaps	0xFF-0xFF(%rax),%xmm15
	lea	0xFF(%rax),%rax
___
$code.=<<___;
.cfi_def_cfa	%rax,8
...
$code.=<<___ if ($addx);
	andl	\$0xFF,%eax
	cmpl	\$0xFF,%eax		# check for MULX and ADO/CX
	je	.Lby_one_callx
___
$code.=<<___;
	call	__rsaz_512_reduce
...
.Lreduction_loopx:
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	32(%rbp), %rbx, %r12
	 mov	%rdx, %rax
	 mov	%r8, %rdx
	adcx	%rbx, %r11
	adox	%r13, %r12
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	48(%rbp), %rax, %r14
	adcx	%rax, %r13
	adox	%r15, %r14
...
.Loop_mulx:
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	32($ap), %rax, %r12
	adcx	%rax, %r11
	adox	%r13, %r12
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	8($ap), %rax, %r9
	adcx	%rax, %r8
	adox	%r10, %r9

	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	16($ap), %rax, %r10
	adcx	%rax, %r9
	adox	%r11, %r10
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF	# mulx	56($ap), %rax, %r15
	adcx	%rax, %r14
	adox	$zero, %r15
	adcx	$zero, %r15
...
.LSEH_begin_rsaz_512_gather4:
	...
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm7,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm8,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm9,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm10,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm11,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm12,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF		# movaps %xmm13,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0,0,0	# movaps %xmm14,0xFF(%rsp)
	.byte	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0,0,0	# movaps %xmm15,0xFF(%rsp)
___
$code.=<<___;
	movd	$power,%xmm8
	movdqa	.Linc+16(%rip),%xmm1	# 00000002000000020000000200000002

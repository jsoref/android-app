...
$code.=<<___;
	...
	vperm2i128	\$0xFF, $T1, $T0, $X0	# X0 = [D0 C0 B0 A0]
	vperm2i128	\$0xFF, $T3, $T2, $X1	# X1 = [D1 C1 B1 A1]
	vperm2i128	\$0xFF, $T1, $T0, $X2	# X2 = [D2 C2 B2 A2]
	vperm2i128	\$0xFF, $T3, $T2, $X3	# X3 = [D3 C3 B3 A3]

	vperm2i128	\$0xFF, $T5, $T4, $Y0
	vperm2i128	\$0xFF, $T7, $T6, $Y1
	vperm2i128	\$0xFF, $T5, $T4, $Y2
	vperm2i128	\$0xFF, $T7, $T6, $Y3
	vmovdqa		(%rdx), $T7
...
.Lconv_loop:
	...
	vperm2i128	\$0xFF, $T1, $T0, $D0	# X0 = [D0 C0 B0 A0]
	vperm2i128	\$0xFF, $T3, $T2, $D1	# X1 = [D1 C1 B1 A1]
	vperm2i128	\$0xFF, $T1, $T0, $D2	# X2 = [D2 C2 B2 A2]
	vperm2i128	\$0xFF, $T3, $T2, $D3	# X3 = [D3 C3 B3 A3]
...
.Lavx2_mul_by1_x4_loop:
	...
	.byte		0xFF,0xFF,0xFF,0xFF,0,0,0	# lea	32*1($a_ptr), $a_ptr

...
.gcm_init_p8:
	...
	vspltisb	$xC2,-16		# 0xFF
	vspltisb	$t0,1			# one
	vaddubm		$xC2,$xC2,$xC2		# 0xFF
	vxor		$zero,$zero,$zero
	vor		$xC2,$xC2,$t0		# 0xFF
	vsldoi		$xC2,$xC2,$zero,15	# 0xFF...
	vsldoi		$t1,$zero,$t0,1		# ...1
	vaddubm		$xC2,$xC2,$xC2		# 0xFF...
	vspltisb	$t2,7
	vor		$xC2,$xC2,$t1		# 0xFF....01
...
Lgcm_ghash_p8_4x:
	...
	lvsl		$t0,0,r8		# 0xFF..0e0f
	#lvx_u		$H2l,r8,$Htbl		# load H^2
	li		r8,0xFF
	lvx_u		$H2, r9,$Htbl
	li		r9,0xFF
	vspltisb	$t1,8			# 0xFF..0808
	#lvx_u		$H2h,r10,$Htbl
	li		r10,0xFF
	...
	vsldoi		$t2,$zero,$t1,8		# 0xFF..0808
	vaddubm		$hiperm,$t0,$t2		# 0xFF..1617
	vaddubm		$loperm,$t1,$hiperm	# 0xFF..1e1f

...
# if BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0xFF)) \
    || BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0xFF))
#  define ASIO_ENABLE_ARRAY_BUFFER_WORKAROUND
# endif // BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0xFF))
        // || BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0xFF))
